...
_The original [nvm](https://github.com/nvm-sh/nvm) is a completely separate project for Mac/Linux only._ This project uses an entirely different philosophy and is not just a clone of nvm. Details are listed in [Why another version manager?](https://github.com/coreybutler/nvm-windows#bulb-why-another-version-manager) and [what&#39;s the big difference?](https://github.com/coreybutler/nvm-windows#bulb-whats-the-big-difference).
</details>
