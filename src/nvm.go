...
func help() {
	...
	fmt.Println("  nvm install                  : Get the version from the .nvmrc file, install it and then use it.")
	...
	fmt.Println("  nvm use                      : Switch to the version specified in the .nvmrc file.")
